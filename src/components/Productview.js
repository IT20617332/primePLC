...
<a href="/Accounting"><Button variant="outline-secondary">Back</Button></a>{" "}
<div style={{paddingTop:"5vh",paddingLeft:"4vh",paddingRight:"5vh"}}>

<h1 data-testid="heading" >Added products:</h1>
<div style={{paddingLeft:"10vh",paddingRight:"10vh",paddingTop:"5vh"}}>
