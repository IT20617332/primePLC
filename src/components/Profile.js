...
// Add Profiles
   const addsOrEditprofile= obj=>{
    firebaceDb.child('profiles').push(
        obj,
        err =>{
            if(err)
            console.log(err)
...
return(
<div style={{paddingTop:"5vh",paddingLeft:"3vh",paddingBottom:"17vh",backgroundColor: "#AEAEAE"}}>
<a href="/"><Button variant="outline-dark" >Back</Button></a>
<Container>
  <Row>
    <Col><Profileform addsOrEditprofile={addsOrEditprofile}/></Col>
